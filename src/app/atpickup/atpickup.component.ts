...
@Component({
  selector: 'app-atpickup',
  templateUrl: './atpickup.component.html',
  styleUrls: ['./atpickup.component.scss']
})
export class AtpickupComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    var params = {
      ...
      maxBodyLength: Infinity,
        ...
        headers: { 
          'Authorization': 'Bearer eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJhZ2Fyd2FsX3VzciIsImlhdCI6MTY3NDI3MDc4NywiYXBwcyI6ImRhdGFwdXNoIn0.3VHlOzuMer1kY9YNsxV08UV0xoNrtqeyuxsea3tdPKxUNM4dnayqxn_JEiJcpbc1ePAhgD26Bmn1QswW5FRo2g', 
      ...
      // var google_config = {
      //   method: 'get',
      //   url: 'https://script.google.com/macros/s/AKfycbzaTq-dYbblb7yREO7nJgZKSHkmRcI9rrP8za9AVLKa6oKEX_C9n0JCuHROY0MN7GwBhw/exec?action=getUser',
      //   headers: { 
      ...
      //   this.googlesheet =response.data;
      //   console.log(this.googlesheet,"asdsad")
      // })
      // .catch(function (error) {
      //   console.log(error);
      // });
